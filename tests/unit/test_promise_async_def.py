...
from repoach.review.dev_runner import _test_function_names_in_file
from repoach.review.spec_gate import promised_present
...
def test_async_only_test_file_not_placeholder(tmp_path: Path) -> None:
    ...
    from repoach.review.coder_loop import is_placeholder_content
