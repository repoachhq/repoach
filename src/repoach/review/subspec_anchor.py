...
:func:`repoach.review.spec.maybe_load_active_spec`, which then returns ``None`` (the
...
Unlike :func:`repoach.review.spec.detect_spec_from_branch`, this is anchored to the
