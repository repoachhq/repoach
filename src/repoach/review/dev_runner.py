...
The runner is the unit invoked by ``repoach develop <spec-id>``.
...
def _run_selector_at_commit(repo_root: Path, sha: str, selector: str) -> bool:
    ...
    """
    tmp_dir = tempfile.mkdtemp(prefix="repoach-wrapup-")
    try:
...
def open_pr(
    *,
    ...
    body = (
        ...
        f"Spec: {spec_ref}\n\n"
        f"Summary: {summary}\n\n"
        "_Generated by `repoach develop`. The NIM review pipeline "
