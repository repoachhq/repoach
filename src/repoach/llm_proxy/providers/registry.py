...
from repoach.llm_proxy.providers.catalog import (
...
def _create_open_router(config: ProviderConfig, _settings: Settings) -> BaseProvider:
    from repoach.llm_proxy.providers.open_router import OpenRouterProvider

    return OpenRouterProvider(config)


def _create_claude_code(config: ProviderConfig, settings: Settings) -> BaseProvider:
    from repoach.llm_proxy.providers.claude_code import ClaudeCodeProvider
