...
class NimSettings(BaseModel):
    ...
    def validate_float_fields(cls, v, info: ValidationInfo):
        ...
        try:
            ...
            raise ValueError(f"{info.field_name} must be a float. Got {type(v).__name__}.") from err
        return val
    ...
    def validate_int_fields(cls, v, info: ValidationInfo):
        ...
        try:
            ...
            raise ValueError(f"{info.field_name} must be an int. Got {type(v).__name__}.") from err
        return val
    ...
    def parse_optional_int(cls, v, info: ValidationInfo):
        ...
        try:
            ...
            raise ValueError(f"{info.field_name} must be an int or empty/None.") from err
